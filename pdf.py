...
@pdf_blueprint.route("/index")
def pdf_project():
    return render_template("pdf.html")


@pdf_blueprint.route("/img_to_doc")
def img_to_doc():
    return render_template("img_to_doc.html")


@pdf_blueprint.route("/pdf_to_doc")
def pdf_to_doc():
...
@pdf_blueprint.route("/upload_image", methods=["POST"])
def upload_image():
    if "file" not in request.files:
        return "Nenhum arquivo enviado", 400
...
@pdf_blueprint.route("/uploads/<filename>")
